...
import { useAnalytics } from './SEOHead';
...
function WhatsAppIcon({ className = "w-6 h-6" }: WhatsAppIconProps): JSX.Element {
    return (
        <svg 
            className={className}
            fill="currentColor" 
...
export function FloatingWhatsApp(): JSX.Element {
    const { trackWhatsApp, trackEvent } = useAnalytics();
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 group">
            ...
            <a
                href="https://wa.me/5567991146889?text=Olá!%20Gostaria%20de%20solicitar%20um%20orçamento%20para%20móveis%20planejados.%20Podem%20me%20ajudar?"
                target="_blank"
            ...
            >
                <WhatsAppIcon />
                {/* Schema.org para ação */}
                <script type="application/ld+json">
                {JSON.stringify({
                    "@context": "https://schema.org",
                    "@type": "ContactPoint",
                    "telephone": "+55-67-99114-6889",
